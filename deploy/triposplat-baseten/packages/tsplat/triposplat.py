# Vendored from VAST-AI-Research/TripoSplat @ d8db9e018b413dd9c4a9fe22463781bf98e8e68d (MIT).
# Only change from upstream: the flat rom model import ... became a relative
# import so this ships as a package next to Truss own model module.
import numpy as np
import torch
